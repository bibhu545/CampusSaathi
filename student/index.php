      ...
      $(document).ready(function(){
        $("#sel").change(function(){
         ...
         // alert(did);
            $.ajax({
      				type:'post',
      				url : '../college/filters/select-location.php',
      				data:{"did":did},
      ...
      $(document).ready(function(){
        $("#type").change(function(){
         ...
         // alert(typeid);
            $.ajax({
      				type:'post',
      				url : '../college/filters/select-type.php',
      				data:{"did":typeid},
      				success:function(res)
      				{
      ...
      $(document).ready(function(){
        $("#exp").change(function(){
         ...
         // alert(typeid);
            $.ajax({
      				type:'post',
      				url : '../college/filters/select-duration.php',
      				data:{"did":exp},
      				success:function(res)
      				{
        ...
        $("#salary").keypress(function(e){
         ...
         // alert(salary);
          if(e.which==13)
          {
          	$.ajax({
      				type:'post',
      				url : '../college/filters/select-salary.php',
      				data:{"did":salary},
      				success:function(res)
      				{
