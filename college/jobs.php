...
<?php
	...
	$query4 = "SELECT * FROM jobs t1 left join location as t2 on t1.place=t2.place_id LIMIT $start_from,$record_per_page";// as t1 left join location as t2 on t1.place=t2.place_id";
