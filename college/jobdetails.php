...
<?php
	...
	$query5 = "SELECT * FROM experience WHERE id = '".$experience."'";
	$row5 = $db->select($query5);
	$experience = $row5->fetch_assoc();
...
<div class="container">
	<div class="row body">
		...
		<div class="blog-post">
			...
			<div style="float: right;"><a target="_blank" href="http://<?php echo $row["website"]; ?>" class="btn btn-success">Apply Now</a></div>
			<br><br>
			...
			<table class="table">
				...
				<tr><th>Experience : </th><th><?php echo $experience["experience"]; ?></th></tr>
