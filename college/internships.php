...
<?php
	...
	$query4 = "SELECT * FROM internships as t1 left join location as t2 on t1.place=t2.place_id LIMIT $start_from,$record_per_page";
      ...
      $(document).ready(function(){
        $("#sel").change(function(){
         ...
         // alert(did);
            $.ajax({
      				type:'post',
      				url : 'filters/select-location.php',
      				data:{"did":did},
      ...
      $(document).ready(function(){
        $("#exp").change(function(){
         ...
         // alert(typeid);
            $.ajax({
      				type:'post',
      				url : 'filters/select-duration.php',
      				data:{"did":exp},
      				success:function(res)
      				{
...
<div class="row" style="margin-top: 40px;">
		...
		<center><h3><p>Filters</p></h3></center>
	      ...
	      <div class="form-group">
	      	<label>By Place : </label>
					...
					<div class="form-group">
						<label>By Internship Type : </label>
					...
					<div class="form-group">
						...
						<select class="form-control" name="type" id="exp">
							<?php
								...
								foreach($result1 as $k1)
								{
									echo "<option value='".$k1["id"]."'>".$k1["duration"]."</option>";
								}
							?>
						</select>
					</div>
	    	...
	    	<div class="form-group">
	    		<label>By Scolarship : </label>
	    		<input type="text" name="salary" placeholder="Enter minimum scolarship" class="form-control" id="salary">
	    	</div>
					<div class="form-group">
						<label>By date : </label>
	...
	<?php  while($jobs = $row4->fetch_assoc()): ?>
		...
		<div class="post-job" style="padding-top: 20px">
			<div class="col-xs-9">
				<h3><?php echo $jobs["title"]; ?></h3>
				<table class="table">
					<tr><td colspan="2">Posted By : <?php echo $jobs["companyid"]; ?></td></tr>
			...
			<div class="col-xs-3">
				...
				<br><br>
				<a href="interndetails.php?id=<?php echo $jobs["id"]; ?>" class="btn btn-primary knowmore" >know more</a>
			</div>
		</div>
	<?php endwhile; ?>
 <br>
                   <div align="center">
                        ...
                        ?>
                              ...
                              <a href="internships.php?page=<?php echo $j; ?>" class="btn btn-primary input">Previous</a>
                              <a href="internships.php?page=<?php echo $i; ?>" class="btn btn-primary input">Next</a>
