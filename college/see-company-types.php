...
<?php
	...
	$query1 = "SELECT * FROM company_master WHERE type = '$type'";// as t1 left join company_type as t2 on t1.type=t2.id";
...
<div class="row">
	...
	<div class="col-xs-6 body-middle-company">
		<br><br>
		<center><h2 style="font-family: Georgia,'Times New Roman',Times, serif;">See all <?php echo $college_type['type']; ?> Industries</h2><br></center>
		<div class="list-group related">
				
		<?php while($college1 = $row1->fetch_assoc()): ?>

			<a href="companydetails.php?id=<?php echo $college1['id']; ?>" class="list-group-item college-list"><?php echo $college1['name']; ?></a>
		<?php endwhile; ?>
		<br>
		</div>
	</div>
