...
<?php 
	...
	if(isset($_REQUEST['knowmore']))
	{
		...
		{
			header('location:internships.php?msg=You Have to login as a student or as a college.');
		}
		else
		{
			if($_SESSION['student'])
      ...
      $(document).ready(function(){
        $("#sel").change(function(){
         ...
         // alert(did);
            $.ajax({
      				type:'post',
      				url : 'libraries/select-location-intern.php',
      				data:{"did":did},
      ...
      $(document).ready(function(){
        $("#type").change(function(){
         ...
         // alert(typeid);
            $.ajax({
      				type:'post',
      				url : 'libraries/select-type-intern.php',
      				data:{"did":typeid},
      				success:function(res)
      				{
      ...
      $(document).ready(function(){
        $("#exp").change(function(){
         ...
         // alert(typeid);
            $.ajax({
      				type:'post',
      				url : 'libraries/select-duration-intern.php',
      				data:{"did":exp},
      				success:function(res)
      				{
        ...
        $("#salary").keypress(function(e){
         ...
         // alert(salary);
          if(e.which==13)
          {
          	$.ajax({
      				type:'post',
      				url : 'libraries/select-salary-intern.php',
      				data:{"did":salary},
      				success:function(res)
      				{
        ...
        $("#date").keypress(function(e){
         var date =$(this).val();
          ...
          if(e.which==13)
          {
          	$.ajax({
      				type:'post',
      				url : 'libraries/select-date-intern.php',
      				data:{"did":date},
      				success:function(res)
      				{
